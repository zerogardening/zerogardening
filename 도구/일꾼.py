...
# 🔴 여기는 **몇 초짜리만** 둔다. 지시를 실제로 처리하는 일은 `지시일꾼`(제 예약)이 한다 —
#    상세페이지 한 장이 세 시간 걸리는데, 같이 두면 그동안 launchd 가 다음 바퀴를 안 띄워
#    (같은 Label) 사진받기가 통째로 멈춘다. 2026-09-14 에 갈랐다.
갈래들 = [
    ('제작요청', '제작요청', '받기', ()),
    ('사진받기', '사진받기', '받기', (False,)),
    ('착수', '지시함', '착수쌓기', ()),      # 사진 7장이 다 차면 지시함에 줄만 쌓는다
]
