...
(function (ZG) {
  ...
  var 그림 = {
    ...
    말풍선: '<path d="M20.5 11.8a8 8 0 0 1-8.6 8 8.5 8.5 0 0 1-3.8-.9L3.5 20.5l1.6-4.6a8 8 0 0 1-.9-3.8 8 8 0 0 1 8-8.6h.5a8 8 0 0 1 7.8 7.8Z"/>',
  ...
  /* 🔴 2026-09-14 — 「재고」를 뺐다. 입고 탭 **안**의 속탭(기본화면·입고내역·작업중)으로
     들어갔기 때문이다(우람님 「입고 탭 하나에 다 묶는다」). `#재고` 해시는 그대로 살아 있어
     예전 링크로 들어와도 그 속탭이 열린다. */
  var 탭칸 = [
